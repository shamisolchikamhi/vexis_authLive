...
`arboreal-cat-451816-n0.webinar_jam.webinarjam_registrants_copy`
as
SELECT distinct * FROM `arboreal-cat-451816-n0.webinar_jam.webinarjam_registrants` WHERE date(signup_date) >= current_date() ;
delete from `arboreal-cat-451816-n0.webinar_jam.webinarjam_registrants` WHERE date(signup_date) >= current_date();
insert into `arboreal-cat-451816-n0.webinar_jam.webinarjam_registrants`
select * from `arboreal-cat-451816-n0.webinar_jam.webinarjam_registrants_copy`;
drop table `arboreal-cat-451816-n0.webinar_jam.webinarjam_registrants_copy`;